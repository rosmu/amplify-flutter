...
extension ModelSchema : Equatable {
    public static func == (lhs: ModelSchema, rhs: ModelSchema) -> Bool {
        return lhs.name == rhs.name && lhs.pluralName == rhs.pluralName && lhs.authRules == rhs.authRules && lhs.fields == rhs.fields && lhs.attributes == rhs.attributes
    }
}

extension AuthRule : Equatable {
    public static func == (lhs: AuthRule, rhs: AuthRule) -> Bool {
        return lhs.allow == rhs.allow && lhs.ownerField == rhs.ownerField && lhs.identityClaim == rhs.identityClaim && lhs.groupClaim == rhs.groupClaim && lhs.groups == rhs.groups && lhs.groupsField == rhs.groupsField && lhs.operations == rhs.operations
    }
}
