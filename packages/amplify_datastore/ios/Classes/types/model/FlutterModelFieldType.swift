...
public struct FlutterModelFieldType {
    ...
    init(serializedData: [String: Any]) throws {
        ...
        guard let fieldType = serializedData["fieldType"] as? String
            ...
            throw ModelSchemaError.parse(className: "FlutterModelFieldType", fieldName: "fieldType", desiredType: "String")
        }
    ...
    public func convertToNativeModelField() -> ModelFieldType{
